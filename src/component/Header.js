...
<nav className="navbar navbar-default navbar-static-top m-b-0">
  <div className="navbar-header">
    ...
    <ul className="nav navbar-top-links navbar-left">
      <li><a href="javascript:void(0)" className="open-close waves-effect waves-light visible-xs"><i className="ti-close ti-menu" /></a></li>
      <li className="dropdown">
        <a className="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"> <i className="mdi mdi-gmail" />
      ...
      {/* .Task dropdown */}
      <li className="dropdown">
        <a className="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"> <i className="mdi mdi-check-circle" />
          <div className="notify"><span className="heartbit" /><span className="point" /></div>
        </a>
      ...
      {/* .Megamenu */}
      <li className="mega-dropdown"> <a className="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><span className="hidden-xs">Mega</span> <i className="icon-options-vertical" /></a>
    ...
    <ul className="nav navbar-top-links navbar-right pull-right">
      ...
      <li className="dropdown">
        <a className="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"> <img src="../plugins/images/users/varun.jpg" alt="user-img" width={36} className="img-circle" /><b className="hidden-xs">Steave</b><span className="caret" /> </a>
